...
function entries(obj) {
    //if an obj has a key: value pair
    // the key, then push the value, then push the new array into the bucketlist
    let bucketList = [];
...
// const bucket = ['objName', ]
// let newArr = [];
// if(obj.hasOwnProperty){

// }
// const {name, pizza} = bucket;
// const [,,] = obj;
// return newArr;
// let bucket = [];
// if (!obj.hasOwnProperty){
//     console.log("Object has no values")
// }
// const bucket = [obj.key, obj.value]
// return bucket;